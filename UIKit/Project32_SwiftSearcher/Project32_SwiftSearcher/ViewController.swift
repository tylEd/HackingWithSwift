...
//
//  Created by Tyler Edwards on 9/25/21.
//
...
class ViewController: UITableViewController {
    ...
    func index(item: Int) {
        ...
        item.expirationDate = Date.distantFuture // probably never expire
